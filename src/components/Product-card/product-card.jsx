...
const ProductCard = ({ productcard }) => {
  ...
  const {state: {cartlist}, dispatch: cartDispatch} = useCart() //destructuring cartlist from initial state and renaminf the dispatch from cart contexr as cartDispatch
