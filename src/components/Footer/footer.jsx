      ...
      <div className="grid-container">
        <div>
          ...
          <ul className="footer-items-list">
            <Link className="footer-pills" to="/product-listing">
              <li className="footer-items">Product Listing</li>
            </Link>
            <li className="footer-items">Your orders</li>
            <Link className="footer-pills" to="/cart-management">
              <li className="footer-items">Cart</li>
            </Link>
            <Link className="footer-pills" to="/wishlist">
        ...
        <div>
          ...
          <ul className="footer-items-list">
            <a
              href="https://github.com/KaustubhM1997/electronic-com"
              target="_blank"
              className="footer-pills"
            >
